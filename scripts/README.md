...
asmt-XX/
  asmt-XX-008-01-윤중석/
    asmt-XX-008-01-윤중석.md
  pdf/
    asmt-XX-008-01-01.pdf
    asmt-XX-008-01-02.pdf
```
...
- [원래 PDF 파일명.pdf](/2026-1-008/asmt-XX/pdf/asmt-XX-008-01-01.pdf)
```
...
- PDF는 원래 파일명을 링크 텍스트로 보존하고, 실제 파일명만 `asmt-XX-008-NN-MM.pdf`로 바꾼다.
